...
const BASE_MODES_AND_LINES = [
  ...
  {
    label: "Green Line",
    ids: ["green_b", "green_c", "green_d", "green_e"],
    color: "#00843D",
  },
  { label: "Green Line B", ids: ["green_b"], color: "#00843D" },
  { label: "Green Line C", ids: ["green_c"], color: "#00843D" },
  { label: "Green Line D", ids: ["green_d"], color: "#00843D" },
  { label: "Green Line E", ids: ["green_e"], color: "#00843D" },
