  ...
  return (
    <>
      ...
      <div className="step-body">
        ...
        <div>
          <div className={`radio-option option-one ${props.messageOption === "1" ? "selected-option" : ""}`}>
            <input type="radio" value="1" checked={props.messageOption === "1"} onChange={props.changeMessageOption} />
            <select className="message-select text-16" value={props.cannedMessage} onChange={props.changeCannedMessage}>
          ...
          <div className={`radio-option option-two ${props.messageOption === "2" ? "selected-option" : ""}`}>
            <input
                type="radio" value="2"
            ...
            <textarea
                ...
                onChange={props.changeCustomMessage}></textarea>
          </div>
        </div>
      </div>
    </>
