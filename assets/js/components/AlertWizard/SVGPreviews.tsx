...
const createSVGText = (message: string, orientation: string) => {
  ...
  const medianHeight = orientation === "portrait" ? portraitHeightMedian : landscapeHeightMedian
  ...
  return (
    <text>
      {linesReducer.array.map((line, index) => {
        return (
          <tspan x="0" y={ y + svgLineHeight * index - textHeight/2 } key={index}>{ line }</tspan>
        )
      })}
    </text>
  )
  ...
  render() {
    ...
    return (
      <div className="svg-previews">
        { !this.props.showText ?
          /* Blank SVG */
          <svg width={svgShortSide} height={svgLongSide} viewBox="0 0 1080 1920" version="1.1" xmlns="http://www.w3.org/2000/svg" style={{ background: "#FFDD00"}}>
          ...
          :
          /* Portrait SVG */
          <svg id="portrait-svg" className="portrait-svg" width={svgShortSide} height={svgLongSide} viewBox="0 0 1080 1920" version="1.1" xmlns="http://www.w3.org/2000/svg" style={{ background: "#FFDD00" }}>
