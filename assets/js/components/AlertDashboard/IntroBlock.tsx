  ...
  return (
    <div className="intro-block">
      ...
      <ul className="intro-text">
        <li>
          This tool temporarily replaces Outfront Media advertising content in stations with rider-facing alerts.
        </li>
        <li>
          Use it to reinforce Live PA audio during <span className="emphasized">safety-critical emergencies requiring riders to take action</span>.
        </li>
      </ul>
