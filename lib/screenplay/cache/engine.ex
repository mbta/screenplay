defmodule Screenplay.Cache.Engine do
  @moduledoc """
  Behaviour for the engine that gets plugged into a `Screenplay.Cache.Owner` GenServer.
  """
  ...
  This is usually an S3 Object version_id.
